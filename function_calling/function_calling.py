...
# Change this to your Ollama/Lemonade server url or use localhost if running on the same machine
LLAMA_SERVER_URL = "http://localhost:11434/v1" # for ollama
MODEL_NAME = "gemma2:2b" # the model identifier for the model you are using
LLAMA_SERVER_URL = "http://localhost:8000/api/v1" # for Lemonade server
